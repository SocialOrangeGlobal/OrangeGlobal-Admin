...
import { BookOpen, FileText, ZoomIn, Eye, Download } from "lucide-react";
...
export default function UserViewModal({
  ...
  const documents = selectedUser ? [
    { name: `${selectedUser.fullName} Resume`, type: 'Resume', url: selectedUser.resumeUrl },
    { name: 'Passport Copy', type: 'Passport', url: selectedUser.passportUrl },
    { name: 'Visa Copy', type: 'Visa', url: selectedUser.visaUrl },
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <div className="md:col-span-2"><span className="font-medium text-gray-800 dark:text-white">LinkedIn Profile:</span> {selectedUser.linkedin ? <a href={selectedUser.linkedin.startsWith('http') ? selectedUser.linkedin : `https://${selectedUser.linkedin}`} target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline inline-flex items-center gap-1.5"><svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>{selectedUser.linkedin}</a> : "N/A"}</div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-1.5 dark:border-gray-800 gap-2">
                    <h3 className="text-xs font-bold text-brand-500 mb-2 uppercase tracking-wider flex items-center gap-2">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="relative bg-gray-100 dark:bg-gray-800 h-44 flex items-center justify-center overflow-hidden">
                              ...
                              <button
                                onClick={() => onViewDoc(doc.url, doc.name)}
